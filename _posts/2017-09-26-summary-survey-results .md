...
author: pestefo
description: >
  How is the experience of ROS developers reusing packages?
  How are the contribution dynamics in the ROS Community?
  What are the reasons that ROS Community members hesitate to contribute?
...
![Q4. How experienced are you with ROS?]({{ site.url }}/assets/posts/2017-09-26-summary-survey-results/Chart_Q4_170919.png)

![Q5. Do you have any background in Software Engineering?]({{ site.url }}/assets/posts/2017-09-26-summary-survey-results/Chart_Q5_170919.png)
...
![Q7. How dependent are your projects to 3rd party ROS packages?]({{ site.url }}/assets/posts/2017-09-26-summary-survey-results/Chart_Q7_170919.png)
...
![Q17. What type of contribution have you made to 3rd party ROS packages?]({{ site.url }}/assets/posts/2017-09-26-summary-survey-results/Chart_Q17_170920.png)


We saw that 28% of our respondents acknowledged that they have never made a contribution. From those participants that have contributed, 70% represents *Bug Reports* and 56% *Bug Fixes*. Also, 62% have *Posted a Question* in [ROS Answers](http://answers.ros.org) or Stack Overflow, while a 51% has *Answered one question* on these platforms.
